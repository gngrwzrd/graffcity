...
+ (GDCallback *) callbackWithTarget:(id)_target andAction:(SEL) _selector {
	GDCallback * callback = [[GDCallback alloc] initWithTarget:_target andAction:_selector];
